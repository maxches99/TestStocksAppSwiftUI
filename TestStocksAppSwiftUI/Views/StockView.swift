    ...
    var body: some View {
        ...
        VStack {
            ...
            HStack(alignment: .bottom, spacing: 16) {
                LineChartView(data: [stock.open!, stock.low!, stock.high!, stock.current!], title: "Блять", legend: "Ебаный график")
                BarChartView(data: .init(points: [stock.open!, stock.low!, stock.high!, stock.current!]), title: "Пиздец", legend: "Ебаные палки", style: Styles.barChartMidnightGreenDark)
                PieChartView(data: [stock.open!, stock.low!, stock.high!, stock.current!], title: "Сука", legend: "Ебаный круг")
            }
            .padding()}
